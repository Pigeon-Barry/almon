...
public class Constants {
    ...
    public static final int MONITOR_ID_MAX_LENGTH = 10;
    public static final int SERVICE_ID_MAX_LENGTH = 10;
    public static String API_KEY_HEADER = "x-api-key";


    public static final String SERVICE_REGEX = "[A-Z0-9-]{3,10}";
    ...
    public static final String MONITOR_KEY_REGEX = "[A-Z0-9-]{3,10}";

...
@Service
@Slf4j
public class ActiveAPIAlertServiceImpl extends ScheduledAlertServiceImpl<ActiveAPIAlert> implements ActiveAPIAlertService {


    private final ActiveAPIAlertRepository API_ALERT_REPOSITORY;

    @Autowired
    public ActiveAPIAlertServiceImpl(NotificationService notificationService, ActiveAPIAlertRepository apiAlertRepository) {

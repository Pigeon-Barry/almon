...
@Controller
@RequestMapping("/api/notification/monitor/{monitorId}")
@Slf4j
@PreAuthorize("isAuthenticated()")
public class NotificationMonitorApiController extends APIController {

    public final NotificationService NOTIFICATION_SERVICE;

    @Autowired
    public NotificationMonitorApiController(NotificationService notificationService) {
